...
function handleAnnot(add, annot, objSelector, contents, id, name) {
  ...
  tweenCamera('camerax', 'Placa', 1, function() {}, 0);
  registerInterval(3, function() {
    tweenCamera('camerax', '', 1, function() {}, 0);
  });

  handleAnnot(true, '1', 'paloooo', '', '1', undefined);
  handleAnnot(true, '2', 'Placa', '', '2', undefined);
  handleAnnot(true, '3', 'ganvho', '', '3', undefined);
  handleAnnot(true, '4', 'Cuerpo info', '', '4', undefined);
  handleAnnot(true, '5', 'Plane', '', '5', undefined);
  handleAnnot(true, '6', 'torni2.001', '', '6', undefined);
