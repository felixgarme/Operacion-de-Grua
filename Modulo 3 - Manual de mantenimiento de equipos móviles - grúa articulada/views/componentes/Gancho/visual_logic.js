...
function handleAnnot(add, annot, objSelector, contents, id, name) {
  ...
  handleAnnot(true, '1', 'black', '', '1', undefined);
  handleAnnot(true, '2', 'clip', '', '2', undefined);
  handleAnnot(true, '3', 'red', '', '3', undefined);
  handleAnnot(true, '4', 'gancho', '', '4', undefined);
