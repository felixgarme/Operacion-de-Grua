...
function handleAnnot(add, annot, objSelector, contents, id, name) {
  ...
  handleAnnot(true, '1', 'diente', '', '1', undefined);
  handleAnnot(true, '2', 'torni', '', '2', undefined);
  handleAnnot(true, '3', 'anilloin', '', '3', undefined);
  handleAnnot(true, '4', 'torni2', '', '4', undefined);
  handleAnnot(true, '5', 'anilloex', '', '5', undefined);
